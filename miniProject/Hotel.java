...
public class Hotel {
    ...
    static void CustDetails(int i,int rn)
    {
        ...
        gender2 = sc.next();
          ...
          switch (i) {
            case 1:hotel_ob.luxury_doublerrom[rn]=new DoulbeRoom(name,contact,gender,name2,contact2,gender2);
                break;
            case 2:hotel_ob.deluxe_doublerrom[rn]=new DoulbeRoom(name,contact,gender,name2,contact2,gender2);
                break;
